...
data.raw <- read_excel('path/mic_database.xls',sheet = "database_p")
data.raw <- column_to_rownames(data.raw, "phylum") 
-------
data.raw <- read_excel('path/mic_database.xls',sheet = "database_s")
...
indoor <- read_excel('path/mic_database.xls',sheet = "indoor")
...
indoor <- indoor[,c(3:204)]
-------
indoor <- read_excel('path/mic_database.xls',sheet = "indoor_s")
indoor <- column_to_rownames(indoor, "species")
indoor <- t(indoor)
-------
...
library(limma)
data.raw <- read_excel('path/mic_database.xls',sheet = "indoor")
...
library(dplyr)
library(pathview)
otu <- read_excel('path/function.xls', sheet="MAT.kegg.ko")
...
#input data
data.otu <- read_excel('path/mic_database.xls',sheet = "database_p")
...
-------
data.otu <- read_excel('path/mic_database.xls',sheet = "database_s")
...
##Pathway
data.otu <- read_excel('path/MAT.kegg.ko.xls')
data.otu <- read_excel('path/MAT.cazy.level2.xls')
...
-------
data.otu <- read_excel('path/MAT.kegg.ko.xls')
data.otu <- read_excel('path/MAT.cazy.level2.xls')[,-2]
...
library(dplyr)
library(linkET)
data.otu <- read_excel('path/function.xls',sheet="MAT.kegg.level1")
...
library(limma)
####GO
data.raw <- read_excel('path/function.xls',sheet="meta_GO")
data.raw <- column_to_rownames(data.raw, "#OTU ID")
data = log2(data.raw)
data[data == -Inf] = 0
-------
...
####kegg
data.raw <- read_excel('path/function.xls',sheet = "meta_ko")
...
-------
data.kegg <- read_excel('path/function.xls',sheet="meta_ko")
...
library(dplyr)
library(pathview)
otu <- read_excel('path/function.xls',sheet="meta_ko")
...
##function
sample <- c("choosed ID")
otu <- read_excel('path/function.xls',sheet="meta_pathway")
...
gene <- read_excel('path/mic_database.xls',sheet="WGCNA")
...
library(WGCNA)
###input data
spe <- read_excel('path/mic_database.xls',sheet="WGCNA")
...
library(caret)
###input
all.otu1 <- read_excel('path/mic_database.xlsx',sheet = "SHAP_p")[c(-8,-32,-33),c(1,4)]
all.otu2 <- read_excel('path/mic_database.xlsx',sheet = "SHAP_s")[c(-8,-32,-33),c(1,4)]
-------
all.otu1 <- read_excel('path/mic_database.xlsx',sheet = "SHAP_indoorp")[,c(1,4)]
all.otu2 <- read_excel('path/mic_database.xls',sheet = "SHAO_indoors")[,c(1,4)]
-------
all.otu1 <- read_excel('path/mic_database.xlsx',sheet = "SHAP_p")[,c(1,4)]
all.otu2 <- read_excel('path/mic_database.xlsx',sheet = "SHAP_s")[,c(1,4)]
